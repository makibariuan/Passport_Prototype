              ...
              <div v-if="activeTab === 'Personal'">
                ...
                <div class="pds-section">
                  ...
                  <div class="pds-field-grid">
                    ...
                    <div class="pds-field required">
                      ...
                      <input v-model="user.lastName" class="pds-input" placeholder="e.g. Dela Cruz" />
                      <span class="pds-readonly-tag">From record</span>
                    </div>

                    <!-- First Name -->
                    <div class="pds-field required">
                      <label class="pds-label">First Name<span class="required-star">*</span></label>
                      ...
                      <label class="pds-label">
                        ...
                        <span class="pds-toggle-wrap">
                          ...
                          <button type="button"
                                  ...
                                  @click="hasMiddleName = false; user.middleName = ''">
                            No
                          </button>
                        </span>
                      </label>
                    ...
                    <!-- Suffix -->
                    <div class="pds-field">
                      <label class="pds-label">Suffix <span class="pds-optional">(Optional)</span></label>
                    ...
                    <!-- Date of Birth -->
                    <div class="pds-field required">
                      <label class="pds-label">Date of Birth<span class="required-star">*</span></label>
                ...
                <div class="pds-section">
                  ...
                  <div class="pds-field-grid">
                    <!-- Nationality -->
                    <div class="pds-field required">
                      <label class="pds-label">Nationality<span class="required-star">*</span></label>
                      <div class="pds-flag-select">
                        <span class="pds-flag-preview">{{ selectedNationalityFlag }}</span>
                        <select v-model="user.citizenship"
                    ...
                    <!-- Civil Status -->
                    <div class="pds-field required">
                      <label class="pds-label">Civil Status<span class="required-star">*</span></label>
                    ...
                    <div class="pds-field required">
                      <label class="pds-label">PSA Birth Certificate<span class="required-star">*</span></label>
                    ...
                    <!-- Birth Legitimacy -->
                    <div class="pds-field required">
                      <label class="pds-label">Birth Legitimacy<span class="required-star">*</span></label>
                      <select v-model="user.birthLegitimacy"
                              class="pds-input"
                              :class="{ 'pds-input-error': showValidationErrors && !user.birthLegitimacy }">
                ...
                <div class="pds-section">
                  ...
                  <div class="pds-field-grid">
                    <!-- Country of Birth -->
                    <div class="pds-field required">
                      <label class="pds-label">Country of Birth<span class="required-star">*</span></label>
                      <div class="pds-flag-select">
                        <span class="pds-flag-preview">{{ selectedBirthCountryFlag }}</span>
                        <select v-model="birthCountry"
                                class="pds-input pds-flag-input"
                    ...
                    <div class="pds-field" v-if="birthCountry === 'PH' && birthCity">
                      ...
                      <select v-model="birthBarangay" class="pds-input">
                        ...
                        <option v-for="b in filteredBarangays" :key="b.code" :value="b.code">{{ b.name }}</option>
                      </select>
                    </div>
                    ...
                    <div class="pds-field required" v-if="birthCountry && birthCountry !== 'PH'">
                      ...
                      <input v-model="user.placeOfBirth" class="pds-input" placeholder="Enter city or town" />
                    </div>
                  </div>
                ...
                <div class="form-wrapper">
                  ...
                  <div class="pds-section">
                    ...
                    <div class="pds-field" style="margin-bottom: 20px">
                      <label class="pds-label">Life Status<span class="required-star">*</span></label>
                      <div class="pds-life-status-toggle">
                        ...
                        <button type="button"
                                :class="['pds-life-btn deceased', { active: fatherLifeStatus === 'deceased' }]"
                    ...
                    <div class="pds-field-grid">
                      ...
                      <div class="pds-field required">
                        <label class="pds-label">Last Name<span class="required-star">*</span></label>
                        <input v-model="user.fatherSurname"
                               class="pds-input"
                               :class="{ 'pds-input-error': showValidationErrors && !user.fatherSurname }"
                      ...
                      <div class="pds-field required">
                        <label class="pds-label">First Name<span class="required-star">*</span></label>
                        <input v-model="user.fatherFirstName"
                               class="pds-input"
                               :class="{ 'pds-input-error': showValidationErrors && !user.fatherFirstName }"
                        ...
                        <label class="pds-label">
                          ...
                          <span class="pds-toggle-wrap">
                            ...
                            <button type="button"
                                    ...
                                    @click="fatherHasMiddleName = false; user.fatherMiddleName = ''">
                              No
                            </button>
                          </span>
                        </label>
                        <input v-if="fatherHasMiddleName"
                      ...
                      <!-- Citizenship -->
                      <div class="pds-field required">
                        <label class="pds-label">Citizenship<span class="required-star">*</span></label>
                        <div class="pds-flag-select">
                          <span class="pds-flag-preview">{{ fatherCitizenshipFlag }}</span>
                          <select v-model="user.fatherCitizenship"
                                  class="pds-input pds-flag-input"
                                  :class="{ 'pds-input-error': showValidationErrors && !user.fatherCitizenship }">
                    ...
                    <div v-if="fatherLifeStatus === 'deceased'" class="pds-status-notice deceased">
                      <span>⚫</span>
                      <span>Marked as <strong>Deceased / Absent</strong>. Please still fill in the information as it appears on official documents.</span>
                    </div>
                  </div>
                  <!-- /SECTION: Father -->
                  ...
                  <div class="pds-section">
                    ...
                    <div class="pds-field" style="margin-bottom: 20px">
                      ...
                      <div class="pds-life-status-toggle">
                        ...
                        <button type="button"
                                :class="['pds-life-btn deceased', { active: motherLifeStatus === 'deceased' }]"
                    ...
                    <div class="pds-field-grid">
                      ...
                      <div class="pds-field required">
                        <label class="pds-label">
                          Last Name
                          <span class="pds-maiden-tag">Maiden</span><span class="required-star">*</span>
                        </label>
                        <input v-model="user.motherSurname"
                               class="pds-input"
                               :class="{ 'pds-input-error': showValidationErrors && !user.motherSurname }"
                      ...
                      <div class="pds-field required">
                        <label class="pds-label">First Name<span class="required-star">*</span></label>
                        <input v-model="user.motherFirstName"
                               class="pds-input"
                               :class="{ 'pds-input-error': showValidationErrors && !user.motherFirstName }"
                        ...
                        <label class="pds-label">
                          ...
                          <span class="pds-toggle-wrap">
                            ...
                            <button type="button"
                                    ...
                                    @click="motherHasMiddleName = false; user.motherMiddleName = ''">
                              No
                            </button>
                          </span>
                        </label>
                        <input v-if="motherHasMiddleName"
                      ...
                      <div class="pds-field required">
                        ...
                        <div class="pds-flag-select">
                          ...
                          <select v-model="user.motherCitizenship"
                                  class="pds-input pds-flag-input"
                                  :class="{ 'pds-input-error': showValidationErrors && !user.motherCitizenship }">
                            <option value="">— Select Citizenship —</option>
                            <option v-for="n in nationalities" :key="n.code" :value="n.name">
                              {{ n.flag }} {{ n.name }}
                            </option>
...
<script setup>
  ...
  const updateFamily = async () => {
    try {
      ...
      await axios.patch(
        `https://localhost:5000/api/Families/${userId}`,
        payload,
        { headers: { Authorization: `Bearer ${Auth.token}` } }
      );
      dialogTitle.value = "Success";
