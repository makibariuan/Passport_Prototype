<template>
  <div class="app-layout">
                    ...
                    <template v-if="!showPaymentStatus">
                      ...
                      <div class="payment-group">
                        ...
                        >
                          ...
                          <div class="radio-card__content">
                            <p class="radio-card__title">Home Delivery</p>
                            <div v-if="deliveryOption === 'address'" class="address-selection">
                              <select
                                v-model="selectedAddressType"
                                class="address-select"
                                @change="deliveryOption = 'address'"
                              >
                              ...
                              <div v-if="selectedAddressType" class="address-details">
                                <template v-for="addr in deliveryAddresses" :key="addr.type">
                                  <div
                                    v-if="addr.type === selectedAddressType"
                                    class="address-info"
                                  >
                                    <p v-if="addr.street" class="address-line">
                                      <strong>Street:</strong> {{ addr.street }}
                                    </p>
                                    <p v-if="addr.barangay" class="address-line">
                                      <strong>Barangay:</strong> {{ addr.barangay }}
                                    </p>
                                    <p v-if="addr.cityMunicipality" class="address-line">
                                      <strong>City/Municipality:</strong>
                                      {{ addr.cityMunicipality }}
                                    </p>
                                    <p v-if="addr.province" class="address-line">
                                      <strong>Province:</strong> {{ addr.province }}
                                    </p>
                                    <p v-if="addr.region" class="address-line">
                                      <strong>Region:</strong> {{ addr.region }}
                                    </p>
                                    <p v-if="addr.postalCode" class="address-line">
                                      <strong>Postal Code:</strong> {{ addr.postalCode }}
                                    </p>
                                    <p v-if="addr.country" class="address-line">
                                      <strong>Country:</strong> {{ addr.country }}
                                    </p>
                                    <p v-if="addr.occupation" class="address-line">
                                      <strong>Occupation:</strong> {{ addr.occupation }}
                                    </p>
                                    <p v-if="addr.employer" class="address-line">
                                      <strong>Employer:</strong> {{ addr.employer }}
                                    </p>
                                    <p v-if="addr.officeMobileNumber" class="address-line">
                                      <strong>Office Mobile:</strong> {{ addr.officeMobileNumber }}
                                    </p>
                                    <p v-if="addr.officeLandlineNumber" class="address-line">
                                      <strong>Office Landline:</strong>
                                      {{ addr.officeLandlineNumber }}
                                    </p>
                                  </div>
                                </template>
                              </div>
                            </div>
                            <p v-else class="radio-card__sub">
                      ...
                      <div
                        v-if="
                          ...
                          paymentMethod &&
                          deliveryOption &&
                          (deliveryOption === 'site' || selectedAddressType)
                        "
    ...
    <DialogBox :show="showMessageDialog" :title="messageTitle" @close="showMessageDialog = false">
...
const proceedWithProfile = async () => {
  ...
  try {
    ...
    // Fetch addresses for delivery options
    await fetchAddresses(selectedProfile.value);
...
const fetchAddresses = async (personalInformationId) => {
  try {
    const res = await axios.get(
      `${BACKEND_DOMAIN}/api/Application/Addresses/${personalInformationId}`,
      {
        headers: { Authorization: `Bearer ${Auth.token}` },
      },
    );

    deliveryAddresses.value = res.data;
...
const submit = async () => {
  ...
  try {
    ...
    console.log("selectedAddressType:", selectedAddressType.value);
    ...
    formData.append("AddressSource", selectedAddressType.value ?? "");
...
.address-select:focus {
  outline: none;
  border-color: #1a6fc4;
  box-shadow: 0 0 0 2px rgba(26, 111, 196, 0.1);
}
