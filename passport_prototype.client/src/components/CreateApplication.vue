                  ...
                  <div class="pds-section">
                    ...
                    >
                      ...
                      <div class="pay-actions">
                        <button class="btn-proceed" @click="showPaymentModal = true">
                          Proceed to Payment
                        </button>
                      </div>
                    </div>
                  ...
                  >
                    <div class="modal-box payment-modal">
                      ...
                      <div class="modal-scroll-body">
                        <p class="modal-remind">
                          <strong>Please be reminded of the following:</strong>
                        </p>
                        <ul class="modal-list">
                          <li>
                            Your chosen mode of payment will charge a convenience fee in addition to
                            the passport fee.
                          </li>
                          <li>
                            Fees must be settled within <strong>24 hours</strong> upon receipt of
                            the Reference Number.
                          </li>
                          <li>Your bank may not be available on weekends and holidays.</li>
                          <li>
                            Amount indicated is exclusively for the payment of the Passport
                            Processing Fee. Processing fee is not refundable and not transferable.
                          </li>
                          <li>
                            Applicants are advised to appear on their scheduled appointment with
                            complete requirements or risk forfeiting payment. Applicants availing of
                            courier service shall submit their current passport for cancellation
                            during their appointment.
                          </li>
                          <li>
                            <strong>For TOPS applicants:</strong> Passports for pick-up shall be
                            claimed by you or your authorized representative at the designated
                            Supervising Consular Office (SCO) of TOPS. There are no available
                            courier delivery services on the TOPS site. Further, applicants at TOPS
                            Sites will be unable to request the delivery of their passports on the
                            day of their appointment schedule.
                          </li>
                        </ul>

                        <p class="modal-remind">
                          <strong>Basahin ang mga sumusunod na paalala:</strong>
                        </p>
                        <ul class="modal-list">
                          <li>
                            Ang pinili ninyong mode of payment ay may karagdagang convenience fee,
                            maliban sa passport fee.
                          </li>
                          <li>
                            Ang mga fees ay kailangang mabayaran sa loob ng 24 oras matapos
                            matanggap ang Reference Number. Ang mga bangko o bayad center ay
                            maaaring hindi bukas ng weekend o holidays.
                          </li>
                          <li>
                            Ang amount na nakasaad ay para lamang sa pagbabayad ng Passport
                            Processing Fee.
                          </li>
                          <li>
                            Ang processing fee ay hindi refundable at hindi maaaring i-transfer sa
                            ibang aplikante.
                          </li>
                          <li>
                            Kailangan po ninyong magpunta sa aming tanggapan sa araw ng inyong
                            appointment, dala ang kumpletong passport requirements. Kung hindi
                            makakapunta sa araw ng appointment, ang inyong bayad ay mawawalang bisa.
                          </li>
                          <li>
                            Para sa mga nag-avail ng courier service, kailangang ipresenta ng mga
                            aplikante ang lumang passport para makansela ito ng prosesor.
                          </li>
                          <li>
                            Para sa mga aplikante sa TOPS: Ang mga passports na for pick-up ay
                            kailangang kunin, ninyo o ng inyong representative sa designated na
                            Supervising Consular Office (SCO) ng TOPS. Hindi maaaring mag-request sa
                            TOPS na ipa-deliver ang inyong passport sa araw ng inyong appointment,
                            dahil hindi available ang courier service sa mga TOPS Sites.
                          </li>
                        </ul>
                      </div>
  ...
  ══════════════════════════════════════════ -->
                <teleport to="body">
                  <div
                    ...
                    class="modal-overlay"
                    @click.self="closePaymentSuccess"
                  >
                  ...
                  <div v-if="showEReceipt" class="modal-overlay" @click.self="showEReceipt = false">
                    <div class="modal-box modal-small">
                      ...
                      <div class="dfa-header">
                        <img
                          src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Seal_of_the_Department_of_Foreign_Affairs_of_the_Philippines.svg/240px-Seal_of_the_Department_of_Foreign_Affairs_of_the_Philippines.svg.png"
                          class="dfa-seal"
                          alt="DFA Seal"
                        />
                        <div>
