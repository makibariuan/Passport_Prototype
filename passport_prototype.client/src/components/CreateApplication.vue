      ...
      <template v-else>
        ...
        <div class="tab-wrapper">
              ...
              <div :key="currentStep" class="form-wrapper">
                  ...
                  <div class="pds-section">
                    ...
                    <div class="calendar-time-grid">
                      ...
                      <div class="calendar-wrapper">
                        ...
                        <div class="cal-days">
                          <span v-for="n in calStartBlank" :key="'blank-' + n" class="cal-day blank" />
                          <button v-for="day in calDaysInMonth"
                                  :key="day.date"
                                  class="cal-day"
                                  :class="{
                      ...
                      <div class="time-slots-wrapper">
                        <div v-for="slot in timeSlots"
                          ...
                          <span class="slots-badge"
                            ...
                            {{ slot.slots > 0 ? `Available slots: ${slot.slots}` : 'No slots available' }}
                          </span>
                        </div>
                      </div>
                    </div>
                ...
                <div v-else-if="currentStep === 1">
                  ...
                  <div class="pds-section">
                    <div class="apptype-row">
                      ...
                      <div class="form-group">
                        <label class="form-label">Basis of Philippine Citizenship <span class="required">*</span></label>
                        <div class="select-wrap">
                    ...
                    <div class="form-group" style="margin-top: 18px">
                      <label class="form-label">Foreign Passport Holder <span class="required">*</span></label>
                      <div class="toggle-group">
                        <button class="toggle-btn" :class="{ active: appTypeForm.foreignPassportHolder === true }" @click="appTypeForm.foreignPassportHolder = true">Yes</button>
                        <button class="toggle-btn" :class="{ active: appTypeForm.foreignPassportHolder === false }" @click="appTypeForm.foreignPassportHolder = false">No</button>
                      </div>
                    </div>

                    <div class="form-group" style="margin-top: 18px">
                      <label class="form-label">Courtesy Lane <span class="required">*</span></label>
                      <div class="toggle-group">
                        <button class="toggle-btn" :class="{ active: appTypeForm.courtesyLane === true }" @click="appTypeForm.courtesyLane = true">Yes</button>
                        <button class="toggle-btn" :class="{ active: appTypeForm.courtesyLane === false }" @click="appTypeForm.courtesyLane = false">No</button>
                      </div>
                    </div>
                    ...
                    <div class="apptype-row">
                      <div class="form-group">
                        <label class="form-label">Identification Number <span class="required">*</span></label>
                        <input v-model="appTypeForm.identificationNumber" type="text" class="form-input" placeholder="" />
                      </div>

                      <div class="form-group">
                        <label class="form-label">Identification Document Type <span class="required">*</span></label>
                        <div class="select-wrap">
                ...
                <div v-else-if="currentStep === 2">
                  ...
                  <div class="pds-section">
                    ...
                    <div class="ca-input-row">
                      <input v-model="assistantInput" type="text" class="form-input" placeholder="Assistant's Full Name" @keyup.enter="addAssistant" />
                  ...
                  <div class="pds-section">
                    ...
                    <div class="ca-input-row">
                      <input v-model="companionInput" type="text" class="form-input" placeholder="Companion's Full Name" @keyup.enter="addCompanion" />
                ...
                <div v-else-if="currentStep === 3">
                  ...
                  <div class="pds-section">
                    ...
                    <div class="af-grid-3">
                      <div class="af-field"><span class="af-label">First Name</span><span class="af-value">{{ appForm.firstName }}</span></div>
                      <div class="af-field"><span class="af-label">Middle Name</span><span class="af-value">{{ appForm.middleName }}</span></div>
                      <div class="af-field"><span class="af-label">Last Name</span><span class="af-value">{{ appForm.lastName }}</span></div>
                      <div class="af-field"><span class="af-label">Birth Date</span><span class="af-value">{{ appForm.birthDate }}</span></div>
                      <div class="af-field"><span class="af-label">Gender</span><span class="af-value">{{ appForm.gender }}</span></div>
                      <div class="af-field"><span class="af-label">Nationality</span><span class="af-value">{{ appForm.nationality }}</span></div>
                      <div class="af-field"><span class="af-label">Civil Status</span><span class="af-value">{{ appForm.civilStatus }}</span></div>
                      <div class="af-field"><span class="af-label">PSA Birth Certificate</span><span class="af-value">{{ appForm.psaBirthCert }}</span></div>
                      <div class="af-field"><span class="af-label">Birth Legitimacy</span><span class="af-value">{{ appForm.birthLegitimacy }}</span></div>
                    </div>
                  </div>
                  ...
                  <div class="pds-section">
                    ...
                    <div class="af-grid-3">
                      <div class="af-field af-span-2"><span class="af-label">Current Address</span><span class="af-value">{{ appForm.currentAddress }}</span></div>
                      <div class="af-field"><span class="af-label">Current Country</span><span class="af-value">{{ appForm.currentCountry }}</span></div>
                      <div class="af-field"><span class="af-label">Current Region</span><span class="af-value">{{ appForm.currentRegion }}</span></div>
                      <div class="af-field"><span class="af-label">Current Barangay</span><span class="af-value">{{ appForm.currentBarangay }}</span></div>
                      <div class="af-field"><span class="af-label">Current Postal Code</span><span class="af-value">{{ appForm.postalCode }}</span></div>
                      <div class="af-field"><span class="af-label">Civil Status</span><span class="af-value">{{ appForm.civilStatus }}</span></div>
                      <div class="af-field"><span class="af-label">Personal Mobile</span><span class="af-value">{{ appForm.personalMobile }}</span></div>
                      <div class="af-field"><span class="af-label">Email</span><span class="af-value">{{ appForm.email }}</span></div>
                      <div class="af-field"><span class="af-label">Emergency Person</span><span class="af-value">{{ appForm.emergencyPerson }}</span></div>
                      <div class="af-field"><span class="af-label">Emergency Phone</span><span class="af-value">{{ appForm.emergencyPhone }}</span></div>
                    </div>
                  </div>
                  ...
                  <div class="pds-section">
                    ...
                    <div class="af-family-grid">
                      <div class="af-family-col">
                        ...
                        <div class="af-field"><span class="af-label">First Name</span><span class="af-value">{{ appForm.fatherFirstName }}</span></div>
                        <div class="af-field"><span class="af-label">Last Name</span><span class="af-value">{{ appForm.fatherLastName }}</span></div>
                        <div class="af-field"><span class="af-label">Citizenship</span><span class="af-value">{{ appForm.fatherCitizenship }}</span></div>
                        <div class="af-field"><span class="af-label">Life Status</span><span class="af-value">{{ appForm.fatherLifeStatus }}</span></div>
                      </div>
                      <div class="af-family-col">
                        <div class="af-family-role">MOTHER</div>
                        <div class="af-field"><span class="af-label">First Name</span><span class="af-value">{{ appForm.motherFirstName }}</span></div>
                        <div class="af-field"><span class="af-label">Last Name</span><span class="af-value">{{ appForm.motherLastName }}</span></div>
                        <div class="af-field"><span class="af-label">Citizenship</span><span class="af-value">{{ appForm.motherCitizenship }}</span></div>
                        <div class="af-field"><span class="af-label">Life Status</span><span class="af-value">{{ appForm.motherLifeStatus }}</span></div>
                      </div>
                      <div class="af-family-col">
                        <div class="af-family-role">SPOUSE</div>
                        <div class="af-field"><span class="af-label">First Name</span><span class="af-value">{{ appForm.spouseFirstName }}</span></div>
                        <div class="af-field"><span class="af-label">Middle Name</span><span class="af-value">{{ appForm.spouseMiddleName }}</span></div>
                        <div class="af-field"><span class="af-label">Last Name</span><span class="af-value">{{ appForm.spouseLastName }}</span></div>
                        <div class="af-field"><span class="af-label">Citizenship</span><span class="af-value">{{ appForm.spouseCitizenship }}</span></div>
                        <div class="af-field"><span class="af-label">Life Status</span><span class="af-value">{{ appForm.spouseLifeStatus }}</span></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="pds-section">
                    ...
                    <div class="af-grid-3">
                      <div class="af-field"><span class="af-label">Application Type</span><span class="af-value">{{ appTypeForm.applicationType || '—' }}</span></div>
                      <div class="af-field"><span class="af-label">Basis of Philippine Citizenship</span><span class="af-value">{{ appTypeForm.citizenshipBasis || '—' }}</span></div>
                      <div class="af-field"><span class="af-label">Courtesy Lane Type</span><span class="af-value">{{ appTypeForm.courtesyLane === true ? 'Yes' : appTypeForm.courtesyLane === false ? 'No' : '—' }}</span></div>
                      <div class="af-field"><span class="af-label">Document Type</span><span class="af-value">{{ appTypeForm.documentType || '—' }}</span></div>
                      <div class="af-field"><span class="af-label">Identification Number</span><span class="af-value">{{ appTypeForm.identificationNumber || '—' }}</span></div>
                      <div class="af-field"><span class="af-label">Identification Document Type</span><span class="af-value">{{ appTypeForm.identificationDocType || '—' }}</span></div>
                    </div>
                  </div>
                  ...
                  <div class="pds-section">
                    ...
                    <div class="af-grid-3">
                      <div class="af-field"><span class="af-label">Scheduled Date</span><span class="af-value">{{ selectedDate || '—' }}</span></div>
                      <div class="af-field"><span class="af-label">Scheduled Time</span><span class="af-value">{{ selectedTime || '—' }}</span></div>
                      <div class="af-field"><span class="af-label">Site</span><span class="af-value">{{ selectedSiteInfo.name }}</span></div>
                    </div>
                  </div>
                  ...
                  <div class="af-declaration-box">
                    <label class="af-declaration-label">
                      <input v-model="appForm.declarationChecked" type="checkbox" class="consent-checkbox" />
                      <div class="af-declaration-text">
                        <p>I am aware that possession of a passport is a privilege granted by the Government of Republic of the Philippines only to its citizens.</p>
                        <p>I understand that any errors that I have committed in this online form may result in my application being delayed and that any misrepresentation of information on my part may be considered grounds for refusal/cancellation of my application.</p>
                        <p>I consent to the use of my personal information provided herein for Government to conduct the necessary records check and verification of facts in connection with my passport application.</p>
                        <p>I hereby confirm that all information I have provided herein are true and correct to the best of my knowledge.</p>
                      </div>
                    </label>
                  </div>
                  ...
                  <div class="af-certify-box">
                    ...
                    <label class="af-certify-label">
                      <input v-model="appForm.certifyChecked" type="checkbox" class="consent-checkbox" />
                      <div class="af-declaration-text">
                        <p>The information entered above is true and correct.</p>
                        <p>I have the full knowledge in providing the above information.</p>
                        <p>I understand the purpose of enrolling myself in the registry of the Department of Foreign Affairs (DFA) ePassport Application System.</p>
                        <p>I have personally given my consent to allow the use of the information contained in this form.</p>
                        <p>I understand that this form contains my personal information to be stored in the DFA ePassport Database.</p>
                      </div>
                    </label>
                    <p class="af-note"><strong>Note:</strong> Please make sure all information displayed is correct before proceeding.</p>
                  </div>
                </div>
                ...
                <div v-else-if="currentStep === 4">
                  <div class="pds-section">
                    ...
                    <div v-for="req in requirements" :key="req.id" class="req-item">
                      <label class="req-item__label">{{ req.label }}<span class="required">*</span></label>
                      <div class="upload-zone">
                        <button class="browse-btn" @click.stop="triggerFileInput(req.id)">+ Browse</button>
                      </div>
                      ...
                      <div class="modal-box">
                        ...
                        <div class="modal-body">
                          <table class="conflict-table">
                            <thead>
                              <tr><th></th><th>Detected</th><th>Inserted</th></tr>
                            </thead>
                            <tbody>
                          ...
                          <div class="id-preview-wrap">
                            <img v-if="pendingFilePreviewUrl" :src="pendingFilePreviewUrl" class="id-preview-img" alt="Uploaded ID" />
                  ...
                  <div class="pds-section">
                    ...
                    <template v-if="!showPaymentStatus">
                      ...
                      <div v-if="processingType && paymentMethod && deliveryOption" class="summary-section">
                        ...
                        <div class="pay-actions">
                          <button class="btn-proceed-pay" @click="showPaymentModal = true">Proceed to Payment</button>
                        </div>
                      </div>
                    ...
                    <template v-else>
                      ...
                      <ul class="guidelines-list">
                        <li>Pay in CASH at Bayad Center Branches and Authorized Partners (Robinsons Malls &amp; Supermarkets, LBC, eBiz, Perahub, USSC, Truemoney, Villarica, etc.), or through 7-11 and ECPay outlets. You may also pay via Bayad App available in both iOS and Android devices.</li>
                        <li>Confirmation Payments are processed once payed.</li>
                        <li>We will send a confirmation email to you once processed.</li>
                        <li>Pay the exact amount. Any excess payment will be forfeited. Payments less than the total amount indicated will not be processed.</li>
                        <li>Amount is inclusive of convenience fee. If you are paying for multiple reference numbers, pay separately for each reference number. One transaction per reference number.</li>
                        <li>Make sure to get a reference number before paying.</li>
                        <li>A reference number can only be used once. If you made a short payment by mistake, do not try to correct it by making another bills payment with the same reference number. Contact our helpdesk immediately.</li>
                      </ul>
                      ...
                      <div class="status-nav">
                        <button class="btn-back-pay" @click="showPaymentStatus = false">Back</button>
                        <button class="btn-pay-now" @click="showPaymentSuccess = true">Pay Now</button>
                      </div>
                    </template>
          ...
          <div class="nav-buttons">
            <button class="btn btn-back" :disabled="currentStep === 0" @click="prevStep">← Back</button>
            <div class="step-indicator">Step {{ currentStep + 1 }} of {{ tabs.length }}</div>
            <button v-if="currentStep < tabs.length - 1" class="btn btn-next" @click="nextStep">Next →</button>
        ...
        <div class="modal-box modal-small">
          <div class="success-icon-wrap">
            <svg width="56" height="56" viewBox="0 0 56 56" fill="none">
              ...
              <polyline points="16,28 24,36 40,20" stroke="#34a853" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
          </div>
...
<script setup>
  ...
  const addAssistant = () => {
    ...
    if (name) { assistants.value.push(name); assistantInput.value = '' }
  }
  const addCompanion = () => {
    const name = companionInput.value.trim()
    if (name) { companions.value.push(name); companionInput.value = '' }
  }
  ...
  const validateFile = (file) => {
    if (file.size > MAX_FILE_SIZE) { alert(`File exceeds 5MB.`); return false }
    if (!SUPPORTED_TYPES.includes(file.type)) { alert('Unsupported format. Use jpeg, jpg, png, bmp, or pdf.'); return false }
    return true
  }
  ...
  const confirmAttachment = () => {
    if (pendingFile.value) { attachFile(pendingFile.value.id, pendingFile.value.file); pendingFile.value = null }
...
<style scoped>
  ...
  .terms-card {
    ...
    max-width: 680px;
    width: 100%;
    box-shadow: 0 4px 16px rgba(6,25,94,.07);
  }
  ...
  .modal-card {
    ...
    width: 420px;
    max-width: 92vw;
    box-shadow: 0 8px 40px rgba(6,25,94,.18);
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: 6px;
  ...
  .pds-section {
    ...
    padding: 24px 28px;
    margin-bottom: 20px;
    box-shadow: 0 2px 8px rgba(6,25,94,.05);
  }
  ...
  .cal-day {
    ...
    .cal-day.selected {
      ...
      color: #fff !important;
      box-shadow: 0 2px 8px rgba(6,25,94,.3);
    }
