              ...
              <div :key="currentStep" class="form-wrapper">
                  ...
                  <div class="pds-section">
                    ...
                    <div class="apptype-row">
                      <div class="form-group">
                        ...
                        <input v-model="appTypeForm.identificationNumber"
                               type="text"
                               class="form-input"
                               placeholder="" />
                      </div>
                ...
                <div v-else-if="currentStep === 3">
                  ...
                  <div class="pds-section">
                    ...
                    <div class="af-grid-3">
                      <div class="af-field">
                        <span class="af-label">First Name</span><span class="af-value">{{ appForm.firstName }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">Middle Name</span><span class="af-value">{{ appForm.middleName }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">Last Name</span><span class="af-value">{{ appForm.lastName }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">Birth Date</span><span class="af-value">{{ appForm.birthDate }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">Gender</span><span class="af-value">{{ appForm.gender }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">Nationality</span><span class="af-value">{{ appForm.nationality }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">Civil Status</span><span class="af-value">{{ appForm.civilStatus }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">PSA Birth Certificate</span><span class="af-value">{{ appForm.psaBirthCert }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">Birth Legitimacy</span><span class="af-value">{{ appForm.birthLegitimacy }}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="pds-section">
                    ...
                    <div class="af-grid-3">
                      <div class="af-field af-span-2">
                        <span class="af-label">Current Address</span><span class="af-value">{{ appForm.currentAddress }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">Current Country</span><span class="af-value">{{ appForm.currentCountry }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">Current Region</span><span class="af-value">{{ appForm.currentRegion }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">Current Barangay</span><span class="af-value">{{ appForm.currentBarangay }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">Current Postal Code</span><span class="af-value">{{ appForm.postalCode }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">Civil Status</span><span class="af-value">{{ appForm.civilStatus }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">Personal Mobile</span><span class="af-value">{{ appForm.personalMobile }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">Email</span><span class="af-value">{{ appForm.email }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">Emergency Person</span><span class="af-value">{{ appForm.emergencyPerson }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">Emergency Phone</span><span class="af-value">{{ appForm.emergencyPhone }}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="pds-section">
                    ...
                    <div class="af-family-grid">
                      <div class="af-family-col">
                        ...
                        <div class="af-field">
                          <span class="af-label">First Name</span><span class="af-value">{{ appForm.fatherFirstName }}</span>
                        </div>
                        <div class="af-field">
                          <span class="af-label">Last Name</span><span class="af-value">{{ appForm.fatherLastName }}</span>
                        </div>
                        <div class="af-field">
                          <span class="af-label">Citizenship</span><span class="af-value">{{ appForm.fatherCitizenship }}</span>
                        </div>
                        <div class="af-field">
                          <span class="af-label">Life Status</span><span class="af-value">{{ appForm.fatherLifeStatus }}</span>
                        </div>
                      </div>
                      <div class="af-family-col">
                        <div class="af-family-role">MOTHER</div>
                        <div class="af-field">
                          <span class="af-label">First Name</span><span class="af-value">{{ appForm.motherFirstName }}</span>
                        </div>
                        <div class="af-field">
                          <span class="af-label">Last Name</span><span class="af-value">{{ appForm.motherLastName }}</span>
                        </div>
                        <div class="af-field">
                          <span class="af-label">Citizenship</span><span class="af-value">{{ appForm.motherCitizenship }}</span>
                        </div>
                        <div class="af-field">
                          <span class="af-label">Life Status</span><span class="af-value">{{ appForm.motherLifeStatus }}</span>
                        </div>
                      </div>
                      <div class="af-family-col">
                        <div class="af-family-role">SPOUSE</div>
                        <div class="af-field">
                          <span class="af-label">First Name</span><span class="af-value">{{ appForm.spouseFirstName }}</span>
                        </div>
                        <div class="af-field">
                          <span class="af-label">Middle Name</span><span class="af-value">{{ appForm.spouseMiddleName }}</span>
                        </div>
                        <div class="af-field">
                          <span class="af-label">Last Name</span><span class="af-value">{{ appForm.spouseLastName }}</span>
                        </div>
                        <div class="af-field">
                          <span class="af-label">Citizenship</span><span class="af-value">{{ appForm.spouseCitizenship }}</span>
                        </div>
                        <div class="af-field">
                          <span class="af-label">Life Status</span><span class="af-value">{{ appForm.spouseLifeStatus }}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="pds-section">
                    ...
                    <div class="af-grid-3">
                      <div class="af-field">
                        <span class="af-label">Application Type</span><span class="af-value">{{ appTypeForm.applicationType || "—" }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">Basis of Philippine Citizenship</span><span class="af-value">{{ appTypeForm.citizenshipBasis || "—" }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">Courtesy Lane Type</span><span class="af-value">
                          {{
                      ...
                      <div class="af-field">
                        <span class="af-label">Document Type</span><span class="af-value">{{ appTypeForm.documentType || "—" }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">Identification Number</span><span class="af-value">{{ appTypeForm.identificationNumber || "—" }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">Identification Document Type</span><span class="af-value">
                          {{
                  ...
                  <div class="pds-section">
                    ...
                    <div class="af-grid-3">
                      <div class="af-field">
                        <span class="af-label">Scheduled Date</span><span class="af-value">{{ selectedDate || "—" }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">Scheduled Time</span><span class="af-value">{{ selectedTime || "—" }}</span>
                      </div>
                      <div class="af-field">
                        <span class="af-label">Site</span><span class="af-value">{{ selectedSiteInfo.name }}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="af-declaration-box">
                    <label class="af-declaration-label">
                      <input v-model="appForm.declarationChecked"
                             type="checkbox"
                  ...
                  <div class="af-certify-box">
                    ...
                    <label class="af-certify-label">
                      <input v-model="appForm.certifyChecked"
                             type="checkbox"
                             class="consent-checkbox" />
                      <div class="af-declaration-text">
                ...
                <div v-else-if="currentStep === 5">
                  <div class="pds-section">
                    <p class="appt-title">
                      Appointment for     <span class="hname">
                        {{
                      [appForm.firstName, appForm.middleName, appForm.lastName]
                        .filter(Boolean)
                        .join(" ")
                  ...
                  ───────────────────────────────────── -->
                    <template v-if="!showPaymentStatus">
                      ...
                      <!-- Summary -->
                      <div v-if="processingType && paymentMethod && deliveryOption"
        ...
        <div class="modal-box modal-small">
          <div class="success-icon-wrap">
            <svg width="56" height="56" viewBox="0 0 56 56" fill="none">
              ...
              <polyline points="16,28 24,36 40,20"
                        stroke="#34a853"
                        stroke-width="2.5"
                        stroke-linecap="round"
                        stroke-linejoin="round" />
          ...
          <div style="padding: 18px 22px; display: flex; flex-direction: column; gap: 14px">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr 1fr 100px; gap: 12px">
              ...
              <div class="form-group">
                ...
                <input v-model="newProfile.firstName"
                       type="text"
                       class="form-input"
              ...
              <div class="form-group">
                ...
                <input v-model="newProfile.middleName"
                       type="text"
                       class="form-input"
...
<script setup>
  ...
  // ── Conflict rows: show only the inserted (appForm) data ────────────
  const conflictRows = computed(() => [
    {
      field: "Full Name",
      value: [appForm.value.firstName, appForm.value.middleName, appForm.value.lastName]
        .filter(Boolean)
        .join(" "),
    },
    {
      field: "Address",
      value: appForm.value.currentAddress,
    },
    {
      field: "Date Of Birth",
      value: appForm.value.birthDate,
    },
    {
      field: "Gender",
      value: appForm.value.gender,
    },
    {
      field: "Place Of Birth",
      value: appForm.value.currentCountry,
    },
    {
      field: "Nationality",
      value: appForm.value.nationality,
    },
  ]);
  ...
  const closeAddProfileModal = () => {
    ...
    newProfile.value = { lastName: "", firstName: "", middleName: "", suffix: "", relationship: "" };
  };

  const submitAddProfile = () => {
    if (!newProfile.value.lastName || !newProfile.value.firstName || !newProfile.value.relationship) {
      addProfileError.value = "Last Name, First Name, and Relationship are required.";
      return;
    }
    const fullName = [
